...
import CommissionHotelTable from '@/features/commissions/components/CommissionHotelTable';
import { HotelStatus } from '@/features/hotels/types';
import { useHotelsQuery } from '@/features/hotels/queries';
import { useDebounce } from '@/hooks/useDebounce';

export default function HotelsCommissionPage() {
  ...
  return (
    <div className="m-4 md:m-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-foreground">Hotels Commission Management</h1>
      </div>
      ...
      {isLoading ? (
        ...
        <>
          <CommissionHotelTable hotels={hotels} />
